...
public class PrintService extends Service {
    ...
    private void loop(){
        ...
        while(running){
            ...
            // COZINHA: se der erro aqui, o comprovante continua.
            try{
                fez=processarCozinha(key,mac);
            ...
            // COMPROVANTE: fila independente da cozinha.
            try{
                fez=processarComprovante(key,mac);
            }catch(Exception ignored){}
    ...
    private boolean processarCozinha(
        String key,
        String mac
    ) throws Exception {
    ...
    private boolean processarComprovante(
        String key,
        String mac
    ) throws Exception {
    ...
    private String toTicket(JSONObject p){
        ...
        if(
            ...
            b.append(
                "[[B]]COMANDA EM ABERTO[[N]]\n"
            );
        }else{
            String f=p.optString(
                "forma_pagamento",
                ""
            );
    ...
    @Override public android.os.IBinder onBind(
        Intent i
    ){
        return null;
    }
